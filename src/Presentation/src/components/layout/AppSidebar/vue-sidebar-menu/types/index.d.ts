...
export interface SidebarItem {
    ...
    /**
     * If specified only users matching any specified role will see this item
     */
    requireAnyRole?: string[];

    /**
     * If enabled only anonymous user will see this item
     */
    requireAnonymous?: boolean;

    /**
     * If enabled only authenticated user will see this item
     */
...
export class SidebarMenu extends Vue {
    ...
    /**
     * Sidebar theme (available themes: 'default-theme').
     *
     */
    theme?: string;
