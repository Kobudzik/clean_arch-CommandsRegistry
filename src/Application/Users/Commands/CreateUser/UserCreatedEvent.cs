...
namespace CommandsRegistry.Application.Users.Commands.CreateUser
{
    ...
    {
        private readonly IConfirmEmailSender _confirmAccountMailSender;

        public UserCreatedEventHandler(IConfirmEmailSender confirmAccountMailSender)
        {
        ...
        {
            await _confirmAccountMailSender.SendConfirmationEmail(
                notification.Email,
