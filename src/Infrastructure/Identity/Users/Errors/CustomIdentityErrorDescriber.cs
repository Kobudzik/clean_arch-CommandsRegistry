...
namespace CommandsRegistry.Infrastructure.Identity.Users.Errors
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        public static IdentityError PasswordRepeated => new()
        {
            Code = nameof(IndentityErrorsCodes.PasswordRepeated),
            Description = "You can't use a password you have used before."
        };

        public static IdentityError TokenExpired => new()
        {
