...
//Tests todo
namespace CommandsRegistry.Application.UnitTests.Common.Behaviours
{
    public class RequestLoggerTests
    {
        //private readonly Mock<ILogger<CreatePlaceCommand>> _logger;
        private readonly Mock<ICurrentUserService> _currentUserService;
        //private readonly Mock<IIdentityService> _identityService;

        public RequestLoggerTests()
        {
            //_logger = new Mock<ILogger<CreatePlaceCommand>>();
